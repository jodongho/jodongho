 ...
 * 
 * modify 20160919 jwlim
 * 이미지 업로드 기능 추가. 
 * 이미지 업로드 구현 시 이미지 업로드 URL에 대한 조회 콜백 함수를 인자값으로 전달. 
 * 해당 콜백 함수의 attr로는 png 이미지의 base64 인코딩 값이 전달됨. 
 * base64 디코딩 후 file write, 해당 이미지 경로 리턴 시 에디터에 해당 이미지 태그 생성됨.
 *
 * 예제 >
 ...
 *   },
 *   callback : {
 *     uploadUrl: function() { //ajax 업로드 구현 
 *       return "https://ssl.gstatic.com/s2/oz/images/notifications/spinner_32_794cfa28f324131c58c8934183d55d25.gif";
 *     }
 *   }
 * });
 */
                              ...
                              if (fileInput == null) {
                                  ...
                                  canvasImg.onload = function(e) {
                                      ...
                                      if (_this3.quill.imageResizeWidth == null) {
                                          _this3.quill.imageResizeWidth = 500;
                                      }
