$.namespace("VipKitEventDetail_2018.detail");
VipKitEventDetail_2018.detail = {
	_ajax : common.Ajax,
	snsInitYn : "Y",
    ...
    url : "",
     ...
     initSns : function(){
      ...
      initEvNo : function(){
      	VipKitEventDetail_2018.detail.evtNo = $("#evtNo").val();
      },
      
	init : function(){
		if($("input[id='reCommend']:hidden").val() != ""){
			if(!VipKitEventDetail_2018.detail.checkLogin()){
				return;
			}
        ...
        $("#commmentHeader > .more").click(function(){
            ...
            VipKitEventDetail_2018.detail.getEventMyCommentListAjax();
        ...
        $("#commmentHeader > .tit").click(function(){
            $('#commentList').empty();
            VipKitEventDetail_2018.detail.getEventCommentListAjax();
        });
        ...
        $('.btnShare').click(function(){
        	VipKitEventDetail_2018.detail.dispSnsPopup();
        ...
        $('.btnGreen').click(function(){
            ...
            if(regType == 'regWrite'){
                if(!VipKitEventDetail_2018.detail.checkRepl()){
                    return;
                }
                
                VipKitEventDetail_2018.detail.regEventCommentAjax();
            }else{

                if(!VipKitEventDetail_2018.detail.checkRegAvailable()){
                    return;
                }
                if(!VipKitEventDetail_2018.detail.checkAgrmInfo()){
                    return;
                }
                VipKitEventDetail_2018.detail.regEventAjax();
            }

        });

        VipKitEventDetail_2018.detail.initEvNo(); /* 2017.12.12 */
        VipKitEventDetail_2018.detail.initCommentList(); /* 2017.12.12 */
        VipKitEventDetail_2018.detail.initSns();/* 2017.12.12 */
	},
	/* 2017.12.12 */
	initCommentList : function(){
        ...
        if(evtType == VipKitEventDetail_2018.detail.commenttype || rplYn ==  "Y"){
        	VipKitEventDetail_2018.detail.getEventCommentListAjax();
        }
    ...
    commentModifyMain : function(appenArea,bbcSeq,commentInfo){
        $("#regComment").hide();
        VipKitEventDetail_2018.detail.makeCommentModify(commentInfo,appenArea,bbcSeq)
    },

    /* 2017.12.12 */
    cancelModifyMain : function(showArea){
        showArea.show();
        VipKitEventDetail_2018.detail.removeCommentModify(showArea);
        $("#regComment").show();
    },
    ...
    makeCommentModify : function(commentInfo,showArea, bbcSeq){
        ...
        $buttonModify.click(function(){
            ...
            VipKitEventDetail_2018.detail.uptEventCommentAjax(bbcSeq,cont);
        });
        ...
        $buttonCancel.click(function(){
            ...
            VipKitEventDetail_2018.detail.cancelModifyMain(showArea);
        });
    ...
    getEventCommentListAjax : function(){
        ...
        //연속키 방식
          PagingCaller.init({
              callback : function(){
                  var param = {
                          evtNo : VipKitEventDetail_2018.detail.evtNo,
                  ...
                  common.Ajax.sendRequest(
                          ...
                          , param
                          , VipKitEventDetail_2018.detail._callback_getEventCommentListAjax);
              }
          ,startPageIdx : 0
          ,subBottomScroll : 700
          ,initCall : true
    ...
    _callback_getEventCommentListAjax : function(strData) {
        ...
        if(listCount == 0){
            ...
            $.each(list, function(index, element){
                ...
                if(rplYn == 'Y' && type != VipKitEventDetail_2018.detail.commenttype && $.trim(element.myCommentFlag) == 'Y'){
                    var $divBox = $("<div>").addClass("btn_box");
                    $li.append($divBox);

                    var $buttonModify = $("<button>").addClass("btnGrayH28").text("수정");
                    $buttonModify.click(function(){
                    	VipKitEventDetail_2018.detail.commentModifyMain($(this).parent().parent(),element.bbcSeq,fcont);
                    });
                    $divBox.append($buttonModify);

                    var $buttonCancel = $("<button>").addClass("btnGrayH28").text("삭제");
                    $buttonCancel.click(function(){
                    	VipKitEventDetail_2018.detail.delEventCommentAjax(element.bbcSeq);
                    });
    ...
    _callback_getEventMyCommentListAjax : function(strData) {
        ...
        if(listCount == 0){
            ...
            $.each(list, function(index, element){
                ...
                if(type != VipKitEventDetail_2018.detail.commenttype){
                    var $divBox = $("<div>").addClass("btn_box");
                    $li.append($divBox);
    ...
    regEventCommentAjax: function(){
        ...
        if(!VipKitEventDetail_2018.detail.checkCommentInfo(bbcFcont)){
            return;
        }
	...
	checkVIPInviteJson : function(){
		...
		//2. 회원등급체크
		if(!VipKitEventDetail_2018.detail.checkMbrGradeCD()){
			return;
		}
		...
		//5. 매장선택 체크
		if(!VipKitEventDetail_2018.detail.checkStore()){
			return;
		}
		...
		common.Ajax.sendJSONRequest(
			  ...
			  ,  param
			  , VipKitEventDetail_2018.detail._callback_checkVIPInviteJson
		);
	},
	_callback_checkVIPInviteJson : function(json){
		...
		if(json.ret == "0"){
			//VVIP :  mbrGradeCD == '5'
			alert("정상적으로 신청되었습니다. 1/11(금) 당첨자 안내를 기다려주세요!");
			location.href = url;
		}else{
			alert(json.message);
		}
    ...
    checkMbrGradeCD : function() {
        ...
        if(mbrGradeCD != '5' && mbrGradeCD != '10'){
        	alert("죄송합니다. 신청 대상이 아닙니다. 마이페이지에서 등급을 확인해 주세요.");
            return false;
        }
        return true;
    },
    ...
    checkAgrmInfo : function(){
        ...
        if(regYn == 'Y' && mbrInfoUseAgrYn == 'Y'){
            ...
            if(!$("#chk01").is(":checked")){
            	...
            	VipKitEventDetail_2018.detail.mbrInfoUseAgrYn = 'Y';
            }
        }else{
        	VipKitEventDetail_2018.detail.mbrInfoUseAgrYn = 'N';
        }
        ...
        if(regYn == 'Y' && mbrInfoThprSupAgrYn == 'Y'){
            if(!$("#chk02").is(":checked")){
            	...
            	VipKitEventDetail_2018.detail.mbrInfoThprSupAgrYn = 'Y';
            }
        }else{
        	VipKitEventDetail_2018.detail.mbrInfoThprSupAgrYn = 'N';
        }
        return true;
    },
