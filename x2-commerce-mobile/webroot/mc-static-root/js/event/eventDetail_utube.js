...
monthEvent.detail = {
	...
	init : function(){
		...
		$('#evtServey_1_txt').focusout(function() {
			var $this = $(this);
		...
		$('#evtServey_5_txt').focusout(function() {
			var $this = $(this);
			var maxLength = parseInt($this.attr('maxlength'));
			if ($this.val().length > maxLength) {
				if($this.val().length > maxLength){
	...
	setApplyBtn : function(){
        ...
        common.Ajax.sendJSONRequest(
       		 "GET"
       	   , _baseUrl + "event/utube/checkTopReviewerApply.do"
       	   , param
       	   , function(json){
       		   if(json.ret == '013'){
       			   //기참여
    ...
    topReviewerApply : function(){
        ...
        common.Ajax.sendJSONRequest(
                "POST"
              , _baseUrl + "event/utube/topReviewerApply.do"
              , param
