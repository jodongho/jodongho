...
monthEvent.detail = {
    ...
    init : function(){
            ...
            if(common.app.appInfo == undefined || !common.app.appInfo.isapp){
                ...
                if(!mevent.detail.checkLogin()){
                    ...
                    common.Ajax.sendJSONRequest(
                            "GET"
                          , _baseUrl + "event/20191001/getAppPushYnCntJson.do"
                          , param
        ...
        $("#applyStamp3").click(function(){
            if($(this).hasClass("on")){
                javascript:monthEvent.detail.checkApply('38');
            }
        });
    },
    ...
    getAttendList : function(){
        ...
        common.Ajax.sendJSONRequest(
                "GET"
              , _baseUrl + "event/20191001/getAttendList.do"
              , param
    ...
    addMyStmp : function(){
        if (common.app.appInfo == undefined || !common.app.appInfo.isapp) {
            ...
            if(!mevent.detail.checkLogin()){
                ...
                common.Ajax.sendJSONRequest(
                        "GET"
                      , _baseUrl + "event/20191001/addMyStmpJson.do"
                      , param
    ...
    checkApply : function(fvrSeq){
        ...
        common.Ajax.sendRequest(
                "GET"
              , _baseUrl + "event/20191001/checkApply.do"
              , param
              , function(json){
    ...
    apply : function(fvrSeq,myTotalCnt){
        ...
        common.Ajax.sendJSONRequest(
                "GET"
              , _baseUrl + "event/20191001/apply.do"
              , param
    ...
    addHotdealStmp : function(){
        if (common.app.appInfo == undefined || !common.app.appInfo.isapp) {
            ...
            if(!mevent.detail.checkLogin()){
                ...
                common.Ajax.sendJSONRequest(
                        "GET"
                      , _baseUrl + "event/20191001/addHotdealStmp.do"
                      , param
