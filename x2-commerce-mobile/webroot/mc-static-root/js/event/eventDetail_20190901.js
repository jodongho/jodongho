...
monthEvent.detail = {
            ...
            if(common.app.appInfo == undefined || !common.app.appInfo.isapp){
                ...
                if(!mevent.detail.checkLogin()){
                    ...
                    common.Ajax.sendJSONRequest(
                            "GET"
                          , _baseUrl + "event/20190901/getAppPushYnCntJson.do"
                          , param
    ...
    getAttendList : function(){
        ...
        common.Ajax.sendJSONRequest(
                "GET"
              , _baseUrl + "event/20190901/getAttendList.do"
              , param
    ...
    addMyStmp : function(){
        if (common.app.appInfo == undefined || !common.app.appInfo.isapp) {
            ...
            if(!mevent.detail.checkLogin()){
                ...
                common.Ajax.sendJSONRequest(
                        "GET"
                      , _baseUrl + "event/20190901/addMyStmpJson.do"
                      , param
    ...
    checkApply : function(fvrSeq){
        ...
        common.Ajax.sendRequest(
                "GET"
              , _baseUrl + "event/20190901/checkApply.do"
              , param
              , function(json){
    ...
    apply : function(fvrSeq,myTotalCnt){
        ...
        common.Ajax.sendJSONRequest(
                "GET"
              , _baseUrl + "event/20190901/apply.do"
              , param
    ...
    addHotdealStmp : function(){
        if (common.app.appInfo == undefined || !common.app.appInfo.isapp) {
            ...
            if(!mevent.detail.checkLogin()){
                ...
                common.Ajax.sendJSONRequest(
                        "GET"
                      , _baseUrl + "event/20190901/addHotdealStmp.do"
                      , param
