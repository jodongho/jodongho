...
monthEvent.detail = {
	...
	init : function(){
		...
		$('.close').click(function() {
			//지원서 닫기
			if($('#popForm1').is(':visible') && monthEvent.detail.showPopForm1){
...
//                monthEvent.detail.eventCloseLayer();
	...
	checkTopReviewerApply : function(){
        ...
        common.Ajax.sendJSONRequest(
       		 "GET"
       	   , _baseUrl + "event/20200720/checkTopReviewerApply.do"
       	   , param
	...
	confirmCheck : function(){
		...
		var question7_txt = $.trim($("#question7_txt").val()).replace(/\|/gi, "");

		if(common.isEmpty(question1) || common.isEmpty(question2) || common.isEmpty(question3) || common.isEmpty(question4_txt)
				|| common.isEmpty(question5) || common.isEmpty(question6) || common.isEmpty(question7_txt)){
			alert("모든 항목을 작성해주세요");
			return;
		}
		...
		monthEvent.detail.noteCont = question1 + "|" + question1_txt
							+ "|" + question2 + "|" + question2_txt + "|" + question3 + "|" + question3_txt
							+ "|" + question4_txt + "|" + question5 + "|" + question6 + "|" + question7_txt;
    ...
    topReviewerApply : function(){
        ...
        common.Ajax.sendJSONRequest(
                "POST"
              , _baseUrl + "event/20200720/topReviewerApply.do"
              , param
