...
monthEvent.detail = {
     baseImgPath : _cdnImgUrl + "contents/202007/01attend/",
     notInFvrSeqArr : [],
     currentDay : null,
     layerPolice : false,
     appPushIng : false,
     init : function(){
        ...
        if(monthEvent.detail.currentDay.substring(0,8) >= "20200701" && monthEvent.detail.currentDay.substring(0,8) < "20200720"){	//pc 7월출석체크
	        $(".banner01_01.evtBan").show();
        }else if(monthEvent.detail.currentDay.substring(0,8) >= "20200721" && monthEvent.detail.currentDay.substring(0,8) <= "20200731"){
	        $(".banner01_02.evtBan").show();
        }
    ...
    addMyStmp : function(){
        if (common.app.appInfo == undefined || !common.app.appInfo.isapp) {
            ...
            if(!monthEvent.detail.checkLoginEvt()){
                ...
                common.Ajax.sendJSONRequest(
                        "GET"
                      , _baseUrl + "event/20200701/addMyStmpJson.do"
                      , param
