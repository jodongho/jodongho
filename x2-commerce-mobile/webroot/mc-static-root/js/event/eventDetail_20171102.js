...
monthEvent.detail = {
	...
	addMyStmp : function(){
		...
		common.Ajax.sendJSONRequest(
				"GET"
			  , _baseUrl + "event/20171102/addMyStmpJson.do"
			  , param
	...
	getMyStmpEvent : function(){
		...
		common.Ajax.sendJSONRequest(
				"GET"
			  , _baseUrl + "event/20171102/getMyStmpEventJson.do"
			  , param
	...
	addEvtProd : function(fvrSeq){
		if(fvrSeq != "2" && fvrSeq != "3" && fvrSeq != "4"){
			...
			common.Ajax.sendJSONRequest(
					"GET"
				  , _baseUrl + "event/20171102/addStmpEvtProdJson.do"
				  , param
	...
	getAppOrderCnt : function(){
		...
		common.Ajax.sendJSONRequest(
				"GET"
			  , _baseUrl + "event/20171102/getMyAppOrderCntJson.do"
			  , param
	...
	_callback_getMyAppOrderCntJson : function(json){
		if(json.ordInfo.ordCnt > 0){
			$("div[id='eNum2']").removeClass("no_0").addClass("no_1");
			$("div[id='eNum2']").find("em").text("O");
	...
	updateMyStmpEventAgrYn : function(){
		if(mevent.detail.checkAgrmTwoInfo()){
			...
			common.Ajax.sendJSONRequest(
					"GET"
				  , _baseUrl + "event/20171102/updateMyStmpEventAgrYnJosn.do"
				  , param
