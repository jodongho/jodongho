...
monthEvent.detail = {
    ...
    init : function(){
        ...
        if(common.isLogin()){
            ...
            $(".btn_vote > img:eq(0)").addClass("on");
            $(".btn_vote > img:eq(1)").removeClass("on");
        }

        $(".btn_vote").click(function(){
            if($(".btn_vote > img:eq(0)").hasClass("on")){
    ...
    getApplyYn : function(fvrSeq){
        ...
        common.Ajax.sendRequest(
                "GET"
              , _baseUrl + "event/20190815/getApplyYn.do"
              , param
    ...
    _callback_getApplyYn : function(json){
        if(json.ret == "0"){
            if(json.applyYn == "N"){
                ...
                $(".btn_vote > img:eq(0)").removeClass("on");
                $(".btn_vote > img:eq(1)").addClass("on");
            }
        }else{
            alert(json.message);
        }
    ...
    checkVote : function(){
        ...
        common.Ajax.sendRequest(
                "GET"
              , _baseUrl + "event/20190815/checkVote.do"
              , param
    ...
    getHotdealVoteList : function(){
        ...
        common.Ajax.sendRequest(
                "GET"
              , _baseUrl + "event/20190815/getHotdealVoteList.do"
              , param
    ...
    voteApply : function(){
        ...
        common.Ajax.sendJSONRequest(
                "GET"
              , _baseUrl + "event/20190815/voteApply.do"
              , param
