...
monthEvent.detail = {
    ...
    getApplyYn : function(fvrSeq){
        ...
        common.Ajax.sendRequest(
                "GET"
              , _baseUrl + "event/20191114/getApplyYn.do"
              , param
    ...
    checkVote : function(){
        ...
        common.Ajax.sendRequest(
                "GET"
              , _baseUrl + "event/20191114/checkVote.do"
              , param
    ...
    getHotdealVoteList : function(){
        ...
        common.Ajax.sendRequest(
                "GET"
              , _baseUrl + "event/20191114/getHotdealVoteList.do"
              , param
    ...
    voteApply : function(){
        ...
        common.Ajax.sendJSONRequest(
                "GET"
              , _baseUrl + "event/20191114/voteApply.do"
              , param
