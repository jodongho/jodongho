...
monthEvent.detail = {
     baseImgPath : _cdnImgUrl + "contents/202006/01attend/",
     notInFvrSeqArr : [],
     currentDay : null,
     layerPolice : false,
     appPushIng : false,
    ...
    addMyStmp : function(){
        if (common.app.appInfo == undefined || !common.app.appInfo.isapp) {
            ...
            if(!mevent.detail.checkLogin()){
                ...
                common.Ajax.sendJSONRequest(
                        "GET"
                      , _baseUrl + "event/20200601/addMyStmpJson.do"
                      , param
    ...
    checkApply : function(fvrSeq){
        if(common.app.appInfo == undefined || !common.app.appInfo.isapp){
            ...
            common.Ajax.sendRequest(
                    "GET"
                  , _baseUrl + "event/20200601/checkApply.do"
                  , param
                  , function(json){
                      $(':radio[name="argee1"]:checked').attr("checked", false);
                      $(':radio[name="argee2"]:checked').attr("checked", false);
    ...
    apply : function(fvrSeq,myTotalCnt){
        if(common.app.appInfo == undefined || !common.app.appInfo.isapp){
            ...
            common.Ajax.sendJSONRequest(
                    "GET"
                  , _baseUrl + "event/20200601/apply.do"
                  , param
